...
export type CreateTableStatement<
    TableName extends Identifier = Identifier,
    Columns extends ColumnSpecifier[] = ColumnSpecifier[],
> = {
...
export type ColumnSpecifier<
  Name extends Identifier = Identifier,
  TypeName extends Identifier = Identifier,
> = {
